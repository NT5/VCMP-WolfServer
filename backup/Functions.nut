...
PlayerInfo[id].CCars=0; 
PlayerInfo[id].CProps=0;
PlayerInfo[id].GotoToggle="off"; 
PlayerInfo[id].StatsToggle="off";
}
//~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~
function LoadPlayerData(player) {
if (player) {
local a=QuerySQL(db,"SELECT Level, Goto, CCars, CProps FROM Accounts WHERE Name LIKE '"+player+"'");
...
PlayerInfo[player.ID].Spree=GetSQLColumnData(s,4); PlayerInfo[player.ID].CCars=GetSQLColumnData(a,2); 
PlayerInfo[player.ID].CProps=GetSQLColumnData(a,3); PlayerInfo[player.ID].GotoToggle=GetSQLColumnData(a,1);
PlayerInfo[player.ID].StatsToggle=GetSQLColumnData(s,2); PlayerInfo[player.ID].Level=GetSQLColumnData(a,0); 
PlayerInfo[player.ID].Kills=GetSQLColumnData(s,0); PlayerInfo[player.ID].Deaths=GetSQLColumnData(s,1);
PlayerInfo[player.ID].Joins=GetSQLColumnData(s,3); PlayerInfo[player.ID].Cash=GetSQLColumnData(f,0); 
PlayerInfo[player.ID].Bank=GetSQLColumnData(f,1); FreeSQLQuery(a); FreeSQLQuery(f); FreeSQLQuery(s);
}}
//~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~
...
local a=QuerySQL(db,"UPDATE Accounts SET Level='"+PlayerInfo[id].Level+"',Goto='"+PlayerInfo[id].GotoToggle+"',CCars='"+PlayerInfo[id].CCars+"',CProps='"+PlayerInfo[id].CProps+"'; WHERE Name='"+player.Name+"'");
local s=QuerySQL(db,"UPDATE Accounts SET Kills='"+PlayerInfo[id].Kills+"',Deaths='"+PlayerInfo[id].Deaths+"',Toggle='"+PlayerInfo[id].StatsToggle+"',Joins='"+PlayerInfo[id].Joins+"',Spree='"+PlayerInfo[id].Spree+"' WHERE Name='"+player.Name+"'");
FreeSQLQuery(a); FreeSQLQuery(f); FreeSQLQuery(s);
}}
//~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~
...
{
	local Cash = PlayerCash( player );
	local TotalCash = player.Cash += amount;
	local a = QuerySQL( db, "UPDATE Finance SET Cash = '" + TotalCash + "' WHERE Name = '" + player.Name + "'" );
	FreeSQLQuery( a );
...
function IncreaseBank( player, amount )
{
	...
	local TotalBank = Bank += amount;
	local a = QuerySQL( db, "UPDATE Finance SET Bank = '" + TotalBank + "' WHERE Name = '" + player.Name + "'" );
	FreeSQLQuery( a );
}
//~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~
function DecreaseBank( player, amount )
{
	local Bank = PlayerBank( player );
	local TotalBank = Bank -= amount;
	local a = QuerySQL( db, "UPDATE Finance SET Bank = '" + TotalBank + "' WHERE Name = '" + player.Name + "'" );
...
{
	local q = QuerySQL( db, "SELECT Name, Cash FROM Finance WHERE Name LIKE '" + player.Name + "'" );
	local Cash = GetSQLColumnData( q, 1 ); FreeSQLQuery(q);
	if ( Cash ) return Cash;
	else return 0;
}
//~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~
...
{
	local q = QuerySQL( db, "SELECT Name, Bank FROM Finance WHERE Name LIKE '" + player.Name + "'" );
	local Bank = GetSQLColumnData( q, 1 ); FreeSQLQuery(q);
	if ( Bank ) return Bank;
	else return 0;
}
//~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~o~
